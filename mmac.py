...
Q, Q_d, u, T, indexes = simulate("PYBULLET", traj_gen,
                        controller, Tp, end, multimodel=True)
...
plt.plot(controller.indexes, 'r', label="wybrany")
plt.plot(indexes, 'b', label="prawdziwy")
plt.show()